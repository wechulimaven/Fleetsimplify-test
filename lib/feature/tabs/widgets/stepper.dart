...
class _CustomStepperState extends State<CustomStepper>
  ...
  Color _circleColor(int index) {
    ...
    if (!_isDark()) {
      return widget.steps[index].isActive ? Palette.greenColor : Palette.white;
    } else {
    ...
    return SizedBox(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: widget.steps[index].isActive
              ? null
              : Border.all(color: Palette.greenColor, width: 1.5),
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              // !_isFirst(index)
              //     ? const SizedBox(height: .0, child: VerticalDivider())
              //     : const SizedBox.shrink(),
              _buildIcon(index),
              // !_isLast(index)
              //     ? const SizedBox(height: 18.0, child: VerticalDivider())
              //     : const SizedBox.shrink(),
          ...
          Expanded(
            child: Container(
              ...
              child: _buildHeaderWidget(index),
            ),
          ),
          // _buildLine(!_isLast(index)),
        ],
  ...
  Widget _buildHeaderWidget(index) {
    return Container(
      decoration: BoxDecoration(
